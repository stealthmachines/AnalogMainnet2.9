...
This version is probably a stepping-stone to the preferred v3.0 which does not require POA (~5-10 second blocktimes and ballooning ledger) to function.  However this version demonstrates some strengths of a digital- and blockchain-bound ecosystem.
